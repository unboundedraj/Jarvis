...
export function AssistantShell() {
  return (
    <section className="grid h-full min-h-0 grid-cols-1 grid-rows-[minmax(0,4fr)_minmax(0,1.1fr)] gap-2 sm:grid-rows-2 lg:grid-cols-[minmax(0,1fr)_320px] lg:grid-rows-1 lg:gap-3 lg:items-stretch">
